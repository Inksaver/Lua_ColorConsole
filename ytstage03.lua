...
function main()
	...
	Resize(80, 25)
	Clear()
	--[[ Lua does not have the Python f"interpolated{value} string" or C# $"interpolated{value} string"
		 but it does have the unique string concatenation .. to compensate]]
	print("Hello "..DRED.."Coloured "..DGREEN.."World (This line will NOT print correctly in an IDE"..RESET)
	--[[The line above will not print correctly, as there is no check whether the output is capable of displaying colour
		 The line below uses the global isColoured flag and compensates accordingly]]
	ColorPrint("Hello ~red~Coloured ~green~World (This line will print correctly in an IDE)")
	ColorPrint("Hello "..RED.."Coloured "..GREEN.."World (This line will print correctly in an IDE)"..RESET)
